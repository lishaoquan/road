	...
	<div class="easyui-panel" title="合同基本信息"  data-options="collapsible:true">
		<table cellpadding="2">
			<tr>
				...
				<td><input class="easyui-textbox" type="text" name="name" data-options="required:true" value ="ttt" readonly="readonly"/></td>
				<td class="label">日期:</td>
				<td><input class="easyui-textbox" type="text" name="name" data-options="required:true" readonly="readonly"/></td>
				<td class="label">客户国家:</td>
				<td><input class="easyui-textbox" type="text" name="email" data-options="required:true,validType:'email'" readonly="readonly"/></td>
